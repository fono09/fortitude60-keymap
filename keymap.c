...
[_LOWER] = LAYOUT( \
  ...
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_UNDS, KC_PLUS, KC_LBRC, KC_RBRC, KC_ENT, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_DEL,  KC_HOME, KC_PGDN, KC_END, KC_F4,   KC_F5,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RBRC,    KC_BSLS, \
